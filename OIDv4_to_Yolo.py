...
# python oid_to_yolo.py --dataset train --class_name Person --class_number 0 --copy 1 --names 0 --dummy_name Person --move Person convert
# python oid_to_yolo.py --dataset train --class_name Person --class_number 0 --names 0 --dummy_name Person --move Person convert
# ---------------
